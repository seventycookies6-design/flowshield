...
{
    /// <summary>Full-screen notice on its own screen; the blocked app keeps running.</summary>
    Soft = 1,
...
public class RunningSprint
{
    ...
    /// A completed one ends now, but never after its planned end: a
    ...
    /// (#300). One ended early is always before its planned end, so now is
    /// already right. Sessions saved before #300 keep the end they were saved with.
    /// </summary>
                                       ...
                                       bool completed, bool interrupted)
    {
        ...
        return completed && nowUtc > plannedEndUtc ? plannedEndUtc : nowUtc;
    }
